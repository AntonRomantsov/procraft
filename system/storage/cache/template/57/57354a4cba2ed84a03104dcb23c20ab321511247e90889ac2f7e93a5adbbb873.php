...
class __TwigTemplate_c4c8c1f3c75e0bd1d3ef7d9ea58771f327b3449822ff1c626d5273c52339b57f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 748
        echo "const menu2 = document.getElementById(\"mainMenu\");
";
        // line 752
        echo "
  ...
  burger.addEventListener(\"click\", () => {
    if (burger) {
      ...
      if (burger.classList.contains(\"active\")) {
        if (menu2) menu.classList.add(\"main-menu--active\");

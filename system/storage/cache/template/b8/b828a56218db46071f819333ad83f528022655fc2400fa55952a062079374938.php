...
class __TwigTemplate_793ce3655138c5e625047e57585382d19b7c709386882f2c17ef5308cb709855 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  document.addEventListener(\"mousemove\", (event) => {
    ...
    \$('.main-menu__button').mouseenter(() => {
      ...
      \$('.main-menu').mouseleave(() => {
        console.log(222);
        \$('.nomainpage-menu .header__main-menu_hidden--mod').css('display', 'none !important');
      });
      });

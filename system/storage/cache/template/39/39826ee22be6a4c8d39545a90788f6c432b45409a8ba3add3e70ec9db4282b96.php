...
class __TwigTemplate_61243e58f885d8c587357aee234c69b860c1fa8f573a07e7279450ecc601f5b7 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    window.addEventListener(\"scroll\", function () {
      if(document.documentElement.clientWidth > 1024){
        if (window.pageYOffset > 600) {
          ...
          if (window.pageYOffset > 600) { ";
        // line 895
        echo "            body.classList.add(\"menu-open\");

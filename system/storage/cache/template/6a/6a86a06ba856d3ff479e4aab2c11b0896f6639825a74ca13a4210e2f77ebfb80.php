...
class __TwigTemplate_64349f9e4093a0695a7430bff1ce65a7df2e272b99069c9e1c48b1cdadbee89c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t</style> ";
  ...
  <body>
    ...
    <div class=\"nomainpage-menu\">
      ...
      <nav class=\"main-menu main-menu-nomainpage header__main-menu_hidden--mod\" style=\"display: block;\">
...
\tdocument.addEventListener(\"DOMContentLoaded\", () => {
  ...
  document.addEventListener(\"mousemove\", (event) => {
    ...
    \$('.main-menu').css('width', coords.width + +10 + 'px');

...
class __TwigTemplate_ab366eff9096330b33d5073ba7cad5dbb677fd121da41a888092933c9e646179 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
document.addEventListener(\"DOMContentLoaded\", () => {
  ...
  const menuList = mainMenu.querySelector(\".main-menu__list2\");

...
class __TwigTemplate_a4daa0a3c1cb40f6307f1f3a5529c1fece7e6f5aecbee9a156d7f7261ce7731c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 748
        echo "const menu = document.getElementById(\"mainMenu\");
";
        // line 751
        echo "const closeButton = document.getElementById(\"closeButton\");
alert(burger);
alert(menu);
alert(body);
alert(html);

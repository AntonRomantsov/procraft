...
class __TwigTemplate_4e70e5a85ec1f878c6015f7cdb0c925156897d4708d91d018f4ccbc6bcc2f765 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t  });
    ...
    \$('.main-nav-dropdown').css('left', coords.left + 'px');
  ...
  \$.ajax({
    ...
    window.addEventListener(\"scroll\", function () {
      if (window.pageYOffset > 600) {
        ...
        \$('.main-nav__dropdown').addClass('acroll-dropdown');
        \$('.main-menu').css('left', coords.left + 'px');
      } else {
        body.classList.remove(\"menu-open\");
        \$('.main-menu').css('position', 'static');
        \$('.main-nav__dropdown').removeClass('acroll-dropdown');
      }
    });
</script>

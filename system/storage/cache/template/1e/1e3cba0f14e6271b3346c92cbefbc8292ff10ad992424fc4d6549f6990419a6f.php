...
class __TwigTemplate_7253e58a3c8c827b39d7de504b8c6a564c022360e6282661f33037e53b643bdc extends \Twig\Template
{
    private $source;
    private $macros = [];
...
//if (burger && menu && body && html) {
  ...
  burger2.addEventListener(\"click\", () => {
    if (burger2) {
      ...
      if (burger2.classList.contains(\"active\")) {
        ...
        if (menu2) menu2.css(\"display\", \"block\");
  ...
  function closeMenu() {
    ...
    if (menu2) menu2.css('display', 'none');

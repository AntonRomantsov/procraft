...
$_['button_shop']                   = 'Показать в магазине';

// Tab
$_['tab_affiliate']                 = 'Парнер';
$_['tab_address']                   = 'Адрес';
...
$_['summernote']                    = 'ru-RU';
$_['datepicker']                    = 'ru';
$_['module_licence'] = '<div class="col-sm-12" >Данный модуль является частью сборки OpenCart 3 от <a href="https://neoseo.com.ua/" title="Web studio NeoSeo">NeoSeo</a> и использование его отдельно от сборки запрещено.</div>';
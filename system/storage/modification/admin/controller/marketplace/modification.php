...
//ExecutionOrder
	public function updatesorder() {
		...
		if ($this->validate()) {
			$this->model_setting_modification->UpdateSorder($this->request->get['modification_id'], $this->request->get['sort_order']);
...
//ExecutionOrder
			$results = $this->model_setting_modification->getModifications(array('sort'=>'sort_order', 'order'=>'DESC'));
//ExecutionOrder
...
//ExecutionOrder
				'sort_order' => $result['sort_order'] ? $result['sort_order'] : '0',
//ExecutionOrder

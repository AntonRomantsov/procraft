	...
	public function index(){
		...
		if ($product_info) {
			...
			$this->model_catalog_product->updateViewed($this->request->get['product_id']);
				...
				if ($this->config->get('module_giftor_status')) {
					$data['giftor_position'] = $this->config->get('module_giftor_position');
					$data['giftor'] = $this->load->controller('extension/module/giftor', $this->request->get['product_id']);
				}
			...
			*/
			...
			foreach ($this->model_page_form->getAllPageFormsByProduct($this->request->get['product_id']) as $form_val) {
				$data['page_forms'][] = array(

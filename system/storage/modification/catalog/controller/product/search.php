...
$results = $this->model_extension_module_search_engine->getProducts($filter_data);
$product_total = $this->model_extension_module_search_engine->getTotalProducts($filter_data);
			...
			foreach ($results as $result) {
				...
				$data['products'][] = array(
					...
					'attributes'    => isset($attributes[0]['attribute']) ? array_slice($attributes[0]['attribute'], 0, 4) : [],

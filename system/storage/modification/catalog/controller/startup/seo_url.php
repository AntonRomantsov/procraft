...
/* NeoSeo Blog - begin */
          ...
          // OCFilter end
					...
					if ($url[0] == 'spec_filter_id') {
						$this->request->get['ocf'] = 'FV' . $url[1];
					}
					...
					if ($query->row['query'] && $url[0] != 'page_form_id' &&  $url[0] != 'information_id' && $url[0] != 'manufacturer_id' && $url[0] != 'category_id' && $url[0] != 'product_id' && $url[0] != 'article_id' && $url[0] != 'author_id' && $url[0] != 'blog_category_id' && $url[0] != 'spec_filter_id') {
			...
			if (!isset($this->request->get['route'])) {
				...
				if (isset($this->request->get['product_id'])) {
					...
					$this->request->get['route'] = 'product/spec_filter';
				}
			}
		}
	}
	...
	public function rewrite($link) {
		...
		foreach ($data as $key => $value) {
			if (isset($data['route'])) {
				if (($data['route'] == 'product/product' && $key == 'product_id') || (($data['route'] == 'product/manufacturer/info' || $data['route'] == 'product/product') && $key == 'manufacturer_id') || ($data['route'] == 'information/information' && $key == 'information_id') || ($data['route'] == 'page/form' && $key == 'page_form_id') || ($data['route'] == 'product/spec_filter' && $key == 'spec_filter_id')) {

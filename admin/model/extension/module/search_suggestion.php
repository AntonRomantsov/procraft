<?php
 class ModelExtensionModuleSearchSuggestion extends Model{public function install(){$this->load->model('design/layout');$a2ef0286a5d84d1a672e428e76fdf7874=$this->model_design_layout->getLayouts();foreach($a2ef0286a5d84d1a672e428e76fdf7874 as $afd5b4eaff55d4fb38360b5add990abd5){$this->db->query("INSERT INTO ".DB_PREFIX."layout_module SET layout_id = '".(int)$afd5b4eaff55d4fb38360b5add990abd5['layout_id']."', code = 'search_suggestion', position = 'content_top', sort_order = '0'");}}public function getDefaultOptions(){return array('element'=>"#search input[name='search']",'types_order'=>array('category'=>array('sort'=>0),'manufacturer'=>array('sort'=>1),'information'=>array('sort'=>2),'product'=>array('sort'=>3),),'width'=>"100%",'css'=>' 

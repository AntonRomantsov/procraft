                      ...
                      <div class="tab-pane" id="tab-field<?php echo $field_row; ?>">
                        <fieldset>
                          ...
                          <div class="field-group">
                            ...
                            <div class="form-group field-class<?php echo $field_row; ?>">
                              ...
                              <div class="col-sm-12">
                                <input type="text" name="page_form_field[<?php echo $field_row; ?>][class]"  value="<?php echo $field['class']; ?>" class="form-control field-class">
                              </div>
                            </div>
                          </div>
                        </fieldset>
                        <fieldset>
                          ...
                          <div class="form-group field-width<?php echo $field_row; ?>">
                            <label class="col-sm-12 control-label"><span data-toggle="tooltip" title="<?php echo $help_width; ?>"><?php echo $entry_width; ?></span></label>
                            <div class="col-sm-12">
                              <div class="btn-group" data-toggle="buttons">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-12">
                              <select name="page_form_field[<?php echo $field_row; ?>][type]" class="form-control field-type" rel="<?php echo $field_row; ?>">
                                ...
                                <?php } ?>
                                <?php if ($field['type'] == 'color_picker') { ?>
                                <option value="color_picker" selected="selected"><?php echo $text_color_picker; ?></option>
                                <?php } else { ?>
                                <option value="color_picker"><?php echo $text_color_picker; ?></option>
                                <?php } ?>
                          ...
                          <table id="pageformoption-value<?php echo $field_row; ?>" class="table table-striped table-bordered table-hover">
                            <thead>
                              <tr>
                                ...
                                <td class="text-right" style="width: 10%;"><?php echo $entry_default_value; ?></td>
    ...
    html += '<fieldset>';
      ...
      html += '<div class="field-group">';
        ...
        html += '<div class="form-group field-class' + field_row + '">';
          ...
          html += '<div class="col-sm-12">';
            html += '<input type="text" name="page_form_field[' + field_row + '][class]"  value="" class="form-control field-class" />';
          html += '</div>';
        html += '</div>';
      html += '</div>';
    html += '</fieldset>';
          ...
          html += '<div class="form-group">';
            ...
            html += '<div class="col-sm-12">';
              html += '<select name="page_form_field[' + field_row + '][type]" class="form-control field-type" rel="' + field_row + '">';
                ...
                html += '<option value="color_picker"><?php echo $text_color_picker; ?></option>';
        ...
        html += '<table id="pageformoption-value' + field_row + '" class="table table-striped table-bordered table-hover">';
          html += '<thead>';
            html += '<tr>';
              ...
              html += '<td class="text-right" style="width: 10%;"><?php echo $entry_default_value; ?></td>';
              html += '<td class="text-right" style="width: 10%;"><?php echo $entry_sort_order; ?></td>';
...
$(document).delegate('.field-type', 'change', function() {
  ...
  if (this.value == 'select' || this.value == 'radio' || this.value == 'checkbox' || this.value == 'radio_toggle' || this.value == 'checkbox_toggle' || this.value == 'multi_select') {
  ...
  if (this.value == 'text' || this.value == 'textarea' || this.value == 'number' || this.value == 'telephone' || this.value == 'email' || this.value == 'email_exists' || this.value == 'date' || this.value == 'time' || this.value == 'datetime' || this.value == 'postcode' || this.value == 'address' || this.value == 'color_picker' || this.value == 'hidden') {
  ...
  if (this.value == 'header' || this.value == 'paragraph' || this.value == 'hrline') {
    ...
    $('.field-required'+ rel +' select').val(0);
    ...
    if(!$('.field-required'+ rel).hasClass('hide')) {
      if($('.field-required'+ rel +' .field-required.active').attr('data-val') == 1) {
...
$(document).delegate('.field-required', 'click', function() {
  var rel = $(this).attr('rel');
  if (!$('.field-required'+ rel).hasClass('hide') && $(this).attr('data-val') == '1') {
    $('.field-error'+ rel).show();
  } else {
    $('.field-error'+ rel).hide();
  }
...
$('.field-required.active').trigger('click');

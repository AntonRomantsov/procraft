...
$_['text_success']	        = 'Erfolg: Sie haben den Tag Manager modifiziert!';
$_['text_signup']           = 'Melden Sie sich bei Ihrem <a href="https://tagmanager.google.com" target="_blank"><u>Google Tag Manager</u></a> konto und nachdem Sie Ihren Website-Workspace-Container erstellt haben, kopieren Sie den Workspace-Code und fügen Sie ihn ein i.e. GTM-XXXXX';
$_['text_default']          = 'Default';
$_['text_edit']             = 'Edit Settings';
$_['text_about']            = '<p>Für Support besuchen Sie bitte unser Support-Center </p><br><div class="col-sm-12"><center><div class="btn btn-success col-sm-5" style="margin:15px"><a href="https://support.aits.xyz/" target="blank" style="color:white;padding-top:10px;" >Unterstützung</a></div><div class="btn btn-info col-sm-5" style="margin:15px"><a href="https://billing.aits.xyz/order.php?step=1&productGroup=18&product=89" target="blank" style="color:white;padding-top:10px;" >Lizenz kaufen</a></div><center></div><p>Wir verbessern uns ständig und fügen neue Funktionen hinzu. Wenn Ihre erforderliche Tracking-Plattform von unserer Erweiterung nicht unterstützt wird, senden Sie uns bitte eine E-Mail an support@aits.xyz und wir werden Ihnen helfen.</p><p>Wir bieten auch kundenspezifische Entwicklung und Opencart-Fehlersuche und -Entwicklung an. Wenn Sie Fragen haben, senden Sie uns bitte eine E-Mail an support@aits.xyz';
...
$_['text_container']        = '<p>You can use our pre-built container to run the extension using the container id <strong>%s</strong> in primary field.<br></p>';
$_['text_order']            = '';
...
$_['text_cookie_button2']   = 'Settings';
$_['text_cookie_button3']   = 'more info';
...
$_['help_server']				= 'Use Google App Tagmanger Server Container for Tag Manager';
...
$_['help_admin']				= 'Recommended for Production only. Logged in Admin visit will not be sent to Analytics. Enable on production sites';
...
$_['help_cache']				= 'Recomended if you have large catalog and low on server resources, ideal to avoid extra overhead on SQL server due to additional queries.';
$_['help_debug']				= 'Enable / Disable debug log message in error log by tagmanager';
$_['help_route']				= 'Additional route i.e quickcheckout/mycheckout in case you have custom Checkout or Success handler On per line.';
$_['help_route_checkout']		= 'One entry per line. if route=checkout/customcheckout add only checout/customcheckout.<br>Please do not remove default entries.';
$_['help_route_success']		= 'One entry per line. if route=checkout/ordersuccess add only checout/ordersuccess.<br>Please do not remove default entries.';
...
$_['help_customer_data']		    = 'Collect and send User data i.e. Name / Phone / Address. If disabled will override individual settings.';

$_['text_details']              = '';

$_['entry_ajax']			    = 'JQUERY AJAX Mode';
$_['help_ajax']		            = 'For troubleshooting Enabled will use jqery, when disabled XMLHTTP is used.';

$_['entry_pagecache']			= 'Override Page Cache Extensions';

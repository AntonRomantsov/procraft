...
$_['entry_free_delivery_min_amount'] = 'Минимальная сумма до бесплатной доставки'; /* free_delivery_min_amount */
...
$_['entry_aways_show_delivery_block_desc'] = 'Внимание! Не все методы доставки могут быть отображены. Некоторые методы доставки требуют обязательного выбора города до того, как они будут показаны. При включении данной опции блок ввода города будет скрыт, и отображен только для служб доставки, выбранных ниже. Для работы данной опции поля "Страна по умолчанию", "Регион по умолчанию", "Город по умолчанию" должны быть заполнены.';
...
$_['error_warehouse_empty_api_key'] = 'Виджет отключен. API key пуст.';

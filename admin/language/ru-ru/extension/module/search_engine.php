...
// Heading
$_['heading_title']             = 'Поисковая система с морфологией и релевантностью v3.1 [<a href="http://sv2109.com" target="_blank">sv2109.com</a>]';
...
$_['help_search_whole_word']   = 'Кроме поиска по корням слов будет осуществляться также поиск по точному совпадению слова. Это увеличит точность поиска и релевантности но также увеличит размер и скорость создания индексов и может повлиять на скорость поиска. Нужно обновить индексы после изменения';

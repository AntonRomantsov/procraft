...
$_['entry_free_delivery_min_amount'] = 'Minimum order amount for free delivery'; /* free_delivery_min_amount */
...
$_['error_warehouse_empty_api_key'] = 'Widget disabled. API key is empty.';

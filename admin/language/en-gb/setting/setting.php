...
$_['entry_detect_browser_lang'] = 'Detect browser language on first login';
$_['entry_detect_browser_lang_help'] = 'Detect the browser language and show the site in that language when the user first logs in';

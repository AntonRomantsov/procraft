...
$_['entry_free_delivery_min_amount'] = 'Мінімальна сума до бесплатної доставки'; /* free_delivery_min_amount */
...
$_['entry_aways_show_delivery_block_desc'] = "Увага! Не всі методи доставки можуть бути відображені. Деякі методи доставки вимагають обов'язкового вибору міста до того, як вони будуть показані. При включенні даної опції блок введення міста буде приховано, і відображений тільки для служб доставки, обраних нижче. Для використання цієї опції поля 'Країна по замовчуванню', 'Регіон за замовчуванням', 'Місто за замовчуванням' повинні бути заповнені.";
...
$_['error_warehouse_empty_api_key'] = 'Виджет вимкнено. API key порожній.';

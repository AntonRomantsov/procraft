...
//UK-UA Ukraine
$_['text_version']          = '';
$_['heading_title']         = 'Tag Manager (Analytics / Pixel / Google Ads)  <a href="http://feofan.club/" target="_blank" title="feofan.club" style="color:#ff7361"><i class="fa fa-download"></i></a> <a href="https://t.me/feofanchat/" target="_blank" title="HELP" style="color:#233746"><i class="fa fa-info-circle"></i></a>';
// Text
$_['primary']               = '';
...
$_['text_about']            = '<p>Щоб отримати підтримку, відвідайте наш центр підтримки </p><br><div class="col-sm-12"><center><div class="btn btn-success col-sm-5" style="margin:15px"><a href="https://t.me/feofanchat/" target="blank" style="color:white;padding-top:10px;" >Підтримка</a></div><div class="btn btn-info col-sm-5" style="margin:15px"><a href="https://t.me/feofanchat" target="blank" style="color:white;padding-top:10px;" >Купити ліцензію</a></div><center></div><p>Ми завжди вдосконалюємося та додаємо нові функції. Якщо ваша розширення не підтримує вашу необхідну платформу відстеження, не соромтеся надсилати нам електронного листа на support@aits.xyz, і ми допоможемо вам. </p> <p> Ми також пропонуємо власну розробку та пошук та усунення несправностей Opencart. Якщо у вас виникли запитання, напишіть нам на support@aits.xyz';
...
$_['help_ajax']		            = 'Для усунення несправностей Enabled використовуватиме jquery, якщо вимкнено, використовується XMLHTTP.';


$_['entry_pagecache']			= 'Заміна кешу сторінки';
$_['help_pagecache']		    = 'Розширення кешу сторінки, такі як Nitro, Lightning, Lightspeed, спричинять неправильні дані користувача/повідомлення про події, що дозволить режиму AJAX впоратися з такою ситуацією.';

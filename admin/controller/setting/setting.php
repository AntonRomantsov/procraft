...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_discount'])) {
			$data['config_discount'] = $this->request->post['config_discount'];
		} else {
			$data['config_discount'] = $this->config->get('config_discount');
		}
		...
		if (isset($this->request->post['config_detect_browser_lang'])) {
			$data['config_detect_browser_lang'] = $this->request->post['config_detect_browser_lang'];
		} else {
			$data['config_detect_browser_lang'] = $this->config->get('config_detect_browser_lang');
		}

...
class ControllerCatalogCategoryMgrLite extends Controller {
    ...
    public function index() {
        ...
        if($interface_lang == 'ru' || $interface_lang == 'ru-ru')
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link('catalog/category_mgr_lite', 'user_token=' . $this->session->data['user_token']. '', 'SSL'),
        );
        ...
        $data['action'] = $this->url->link('module/category_mgr_lite', 'user_token=' . $this->session->data['user_token'], 'SSL');

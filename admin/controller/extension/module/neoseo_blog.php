...
class ControllerExtensionModuleNeoSeoBlog extends NeoSeoController
{
	...
	public function index()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->model_extension_module_neoseo_blog->setModuleStatus($this->request->post[$this->_moduleSysName() . "_status"]);

...
class ControllerProductExtendedReviews extends Controller
{
    ...
    public function review()
    {
        ...
        if ($settings["key"] && $settings["license"] && $settings["status"]) {
            ...
            $review_total = $this->model_catalog_extended_reviews->getTotalPagi($this->request->get["product-id"]);
            ...
            $videos_id = array();
						...
						$review_total_tab = $this->model_catalog_extended_reviews->getTotalReviewsByProductId($this->request->get["product-id"]);

						$data['review_title'] = sprintf($this->language->get('text_reviews'), $review_total_tab);

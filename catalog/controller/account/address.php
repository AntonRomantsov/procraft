...
class ControllerAccountAddress extends Controller {
	...
	public function default() {
		...
		$this->model_account_address->editDefaultAddress($this->request->get['address_id']);
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$data['addresses'][] = array(
				...
				'default' => ($default_address == $result['address_id']),
				'default_url'     => $this->url->link('account/address/default', 'address_id=' . $result['address_id'], 'SSL'),
		...
		$data['action'] = $this->url->link('account/simpleaddress/insert');
		...
		$data['form_add_address'] = $this->load->controller('account/simpleaddress/insert', ['module_lk' => 1, 'module' => 1]);

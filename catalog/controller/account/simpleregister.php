...
class ControllerAccountSimpleRegister extends SimpleController {
    ...
    public function index($args = null) {
        ...
        $this->_templateData['action'] = $this->url->link('account/simpleregister');
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST' && isset($this->request->post['submitted']) && $this->validate()) {
            ...
            $customer_id = $this->model_account_customer->addCustomer($info);
            
            $this->model_account_order->setEarlierOrder($customer_id, $info['telephone']);

...
class ControllerAccountSimpleEdit extends SimpleController {
    ...
    public function index($args = null) {
        ...
        $this->_templateData['account_discount'] = $this->load->controller('extension/module/account_discount');
        $this->_templateData['account'] = $this->load->controller('extension/module/account');
        ...
        $this->_templateData['email'] = $customer_info['email'];
        $this->_templateData['firstname'] = $customer_info['firstname'];
        $this->_templateData['lastname'] = $customer_info['lastname'];
        $this->_templateData['telephone'] = $customer_info['telephone'];

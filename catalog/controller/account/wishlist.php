...
class ControllerAccountWishList extends Controller {
	...
	public function add() {
		...
		$json['in_wishlist'] = $this->language->get('text_from_wl');
	...
	public function remove(){
		...
		if ($product_info) {
			if ($this->customer->isLogged()) {
				...
				unset($this->session->data['wishlist'][array_search($this->request->post['product_id'], $this->session->data['wishlist'])]);
		...
		$json['in_wishlist'] = $this->language->get('text_wl');

...
class ModelAccountCustomer extends Model {
	...
	public function getManager($manager_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "user WHERE user_id = '" . (int)$manager_id . "'");
	...
	public function getOrderTotals($customer_id) {
		$query = $this->db->query("SELECT SUM(total) AS total FROM " . DB_PREFIX . "order WHERE customer_id = '" . (int)$customer_id . "' AND order_status_id IN (" . implode(',', $this->config->get('config_complete_status')) . ")");

...
class ModelAccountOrder extends Model {
	...
	public function setEarlierOrder($customer_id, $phone){
		$this->db->query("UPDATE `" . DB_PREFIX . "order` SET customer_id = " . (int)$customer_id . " WHERE telephone = '" . $this->db->escape($phone) . "' AND customer_id = 0");
	}
}
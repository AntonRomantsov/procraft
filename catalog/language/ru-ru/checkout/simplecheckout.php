...
// Text discount
$_['text_discount'] = 'Ваша персольная скидка';
$_['text_discount_info'] = 'Для зарестрированных пользователей действует <a href="%s">накопительная система скидок</a>';
$_['text_next_discount'] = 'До <span>скидки %s</span>  Вам осталось %s';

// Text
$_['text_cart']                      = 'В корзине';
$_['text_checkout_customer']         = 'Контактные данные';

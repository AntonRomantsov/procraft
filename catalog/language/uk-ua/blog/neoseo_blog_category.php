...
//Blogs
$_['blog_category_meta_h1'] = '%s';
$_['blog_category_meta_title'] = '%s. Сторінка №%d';
$_['blog_category_meta_keywords'] = '%s';
$_['blog_category_meta_description'] = '%s. Сторінка №%d';
$_['blog_category_description'] = '';

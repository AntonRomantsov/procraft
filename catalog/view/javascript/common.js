...
var wishlist = {
	'add': function(product_id, elem = false, url = 'index.php?route=account/wishlist/add', reverse = 'index.php?route=account/wishlist/remove') {
		var element = $(this);
		$.ajax({
			url: url,
			type: 'post',
			...
			success: function(json) {
				...
				var el = $('.product-like-' + product_id);
				var el2 = $('.button_gray');
	...
	'remove': function(product_id, elem = false, url = 'index.php?route=account/wishlist/remove', reverse = 'index.php?route=account/wishlist/add') {
        var element = $(this);
		$.ajax({
			url: url,
			type: 'post',

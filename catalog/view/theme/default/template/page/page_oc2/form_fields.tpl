<?php if ($page_form_options) { ?>
  <?php foreach ($page_form_options as $page_form_option) { ?>
    <?php if ($page_form_option['type'] == 'select') { ?>
      <div class="form-group<?php echo ($page_form_option['required'] ? ' required' : ''); ?> <?php echo !empty($page_form_option['width']) ? 'col-sm-'. $page_form_option['width'] : ''; ?> <?php echo !empty($page_form_option['class']) ? $page_form_option['class'] : ''; ?>">
    ...
    <?php if ($page_form_option['type'] == 'textarea') { ?>
      ...
      <?php if ($page_form_option['type'] == 'google_map') { ?>
        <?php if(!empty($page_form_option['field_help'])) { ?>
        <div class="form-group <?php echo !empty($page_form_option['width']) ? 'col-sm-'. $page_form_option['width'] : ''; ?> <?php echo !empty($page_form_option['class']) ? $page_form_option['class'] : ''; ?>">
      ...
      <div class="form-group<?php echo ($page_form_option['required'] ? ' required' : ''); ?> <?php echo !empty($page_form_option['width']) ? 'col-sm-'. $page_form_option['width'] : ''; ?> <?php echo !empty($page_form_option['class']) ? $page_form_option['class'] : ''; ?> upload-wise">
        <label class="control-label"><?php echo $page_form_option['field_name']; ?>
          <?php if(!empty($page_form_option['field_help'])) { ?>
            <i class="fa fa-question-circle" data-toggle="tooltip" title="<?php echo $page_form_option['field_help']; ?>"></i>
          <?php } ?>
        </label>
        <div class="dropzone dropzone-file-area" id="dropzone-upload<?php echo $page_form_option['page_form_option_id']; ?>" data-formid="<?php echo $page_form_id; ?>">
